...
namespace Event
{
    public class EventHandler
    {
        ...
        {
            SetInterval(() => SectionActionHandler.LocomotiveAddedToTrain(), TimeSpan.FromSeconds(10));
            SetInterval(() => SectionActionHandler.WagonAddedToTrain(), TimeSpan.FromSeconds(10));
            SetInterval(() => SectionActionHandler.LocomotiveRemovedFromTrain(), TimeSpan.FromSeconds(10));
